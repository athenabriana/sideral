...
#
# kind defaults to dockerd; on silverfox there is no dockerd (rootless
...
# at). No setup beyond having podman.socket enabled — which silverfox-
...
# (silverfox doesn't ship minikube — kind covers the same need).
