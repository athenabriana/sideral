# athens-os-signing — container/image trust policy

Name:           athens-os-signing
Version:        %{?_athens_version}%{!?_athens_version:0.0.0}
Release:        1%{?dist}
Summary:        Container image trust policy for athens-os (currently permissive placeholder)
License:        MIT
...
# We replace its role for athens-os-specific paths; see UPGRADE.md.
Conflicts:      ublue-os-signing

%description
Ships /etc/containers/policy.json. Currently a permissive placeholder
that matches Fedora's stock default (insecureAcceptAnything) — athens-os
...
packages/athens-os-signing/UPGRADE.md and update the rebase URL.
